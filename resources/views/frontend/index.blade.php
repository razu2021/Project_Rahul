...
<main class="main">
  ...
  <section id="hero" class="hero section dark-background">
    <img src="{{asset('contents/frontend')}}/assets/img/hero-bg.jpg" alt="" data-aos="fade-in">
    <div class="container">
      <div class="row">
        <div class="col-xl-4">
      ...
      <div class="row">
        ...
        <div class="col-lg-5 position-relative" data-aos="zoom-out" data-aos-delay="200">
          <div class="phone-wrap">
            <img src="{{asset('contents/frontend')}}/assets/img/iphone.png" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row gy-5">
        ...
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
          <div class="post-box">
            <div class="post-img"><img src="{{asset('contents/frontend')}}/assets/img/blog/blog-1.jpg" class="img-fluid" alt=""></div>
            <div class="meta">
        ...
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
          <div class="post-box">
            <div class="post-img"><img src="{{asset('contents/frontend')}}/assets/img/blog/blog-2.jpg" class="img-fluid" alt=""></div>
            <div class="meta">
        ...
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="600">
          <div class="post-box">
            <div class="post-img"><img src="{{asset('contents/frontend')}}/assets/img/blog/blog-3.jpg" class="img-fluid" alt=""></div>
            <div class="meta">
        ...
        <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="600">
          <div class="post-box">
            <div class="post-img"><img src="{{asset('contents/frontend')}}/assets/img/blog/blog-4.jpg" class="img-fluid" alt=""></div>
            <div class="meta">
